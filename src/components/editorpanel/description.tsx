function Description(){
    return (
        <div className='px-7 h-auto w-full '>
          <p className='text-white text-base'>It's hard to believe that June is already over! Looking back on the month, there were a few highlights that stand out to me.
            ...
            Overall, it was a good month with a mix of ups and downs. I'm looking forward to what July has in store! I'm hoping to make some more progress on my goals and spend quality time with the people I care about.</p>
         </div>
    )
}
