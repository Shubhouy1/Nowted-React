...
function Editorpanel({setRefreshNotes,refreshNotes}:EditorPanelProps){
    ...
    return (
        <div className='h-screen overflow-hidden w-full flex flex-col gap-5'>
         ...
         <Title titleText={title} setTitle ={setTitle} noteId={note?.id ?? ""} isFavorite = {note?.isFavorite ?? false}
         setRefreshNotes ={setRefreshNotes} setDeletedNoteId = {setDeletedNoteId} isArchived = {note?.isArchived ?? false}
         />
